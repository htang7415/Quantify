...
for required in AWS_REGION AWS_STACK_NAME IMAGE_URI AUDIT_BUCKET_NAME GEMINI_SECRET_ARN GEMINI_SECRET_VERSION_ID; do
...
"$aws_bin" cloudformation deploy \
  ...
  --parameter-overrides "ImageUri=$IMAGE_URI" "AuditBucketName=$AUDIT_BUCKET_NAME" \
