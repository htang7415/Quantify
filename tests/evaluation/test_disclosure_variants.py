...
def test_frozen_disclosure_variants_follow_the_conservative_verdict_table() -> None:
    ...
    for variant in fixture["variants"]:
        report_text = variant["report_text"]
        sentence = variant["claim_sentence"]
            ...
            statements=(
                ExtractedStatement(
                    ...
                    report_span=ReportSpan(
                        span_id="span-s1", sentence_text=sentence, sentence_start=0,
                        sentence_end=len(sentence), claim_fragment=sentence,
                        fragment_start=0, fragment_end=len(sentence),
                    ),
